...
export default function MapComponent(props: MapComponentProps) {
  ...
  const fetchData = async (
    ...
    console.log("Fetching weather data for", latitude, longitude, value, time);
  };
  ...
  <div>
    <div style="font-size: 1.2em; color: #213547; font-weight: bold;">Start Point</div>
        ...
        const marker = new mapboxgl.Marker({
          element: createMarkerElement("safa", 32),
        })
          .setLngLat([lng, lat])
          .setPopup(popup)
          .addTo(map);
